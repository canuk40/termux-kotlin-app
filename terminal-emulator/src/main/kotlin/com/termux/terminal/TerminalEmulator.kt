...
class TerminalEmulator(
    ...
    companion object {
        ...
        /** DECSET 2017 - Kitty keyboard protocol */
        private const val DECSET_BIT_KITTY_KEYBOARD_MODE = 1 shl 13
        ...
        fun mapDecSetBitToInternalBit(decsetBit: Int): Int {
            return when (decsetBit) {
                ...
                2017 -> DECSET_BIT_KITTY_KEYBOARD_MODE
                else -> -1
            }
        }
    }
    ...
    fun isKittyKeyboardMode(): Boolean = isDecsetInternalBitSet(DECSET_BIT_KITTY_KEYBOARD_MODE)
